...
NOISE_EPS = 1.0         # adding decay to noise exploration
NOISE_EPS_DECAY = 1e-6
UPDATE_ONLY = 10
UPDATE_EVERY = 2
...
class Agent():
    ...
    def act(self, state, add_noise=True):
        ...
        if add_noise:
            action += self.noise_eps * np.random.normal(0, 0.1) # Noise from normal distribution.OU Noise seems to not explore 
